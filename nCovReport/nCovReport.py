...
def plot_daily():
    ...
    plt.figure('nCoV最新疫情统计图表', facecolor='#f4f4f4', figsize=(10, 8))
    plt.title('nCoV疫情曲线', fontsize=20)
...
def plot_distribution():
    ...
    font_14 = FontProperties(fname='res/msyh.ttc', size=14)
    font_11 = FontProperties(fname='res/msyh.ttc', size=11)
    ...
    axes.set_title("Latest nCoV Report", fontproperties=font_14)
    FigureCanvasAgg(fig)
    fig.savefig('nCoVReport.png')
